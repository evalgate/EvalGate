...
evalai.config.json             ← SDK config (baseline + report paths)
.github/workflows/evalai-gate.yml ← CI workflow (auto-generated by evalai init)
```

### Two Modes

**Built-in mode** (default after `evalai init`):
