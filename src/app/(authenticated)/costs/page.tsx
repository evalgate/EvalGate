  ...
  useEffect(() => {
    if (!isPending && !session?.user) {
      ...
      setSummary({
        ...
        topModels: [
          { provider: "openai", model: "gpt-4o", totalCost: 125.5, requestCount: 3200 },
          {
            provider: "anthropic",
          ...
          { provider: "google", model: "gemini-1.5-flash", totalCost: 4.3, requestCount: 100 },
        ],
      });
      setTrends([
        { date: "2024-01-01", totalCost: 8.5, tokenCount: 450000, requestCount: 280 },
        { date: "2024-01-02", totalCost: 9.2, tokenCount: 480000, requestCount: 295 },
        { date: "2024-01-03", totalCost: 7.8, tokenCount: 420000, requestCount: 260 },
        { date: "2024-01-04", totalCost: 10.5, tokenCount: 520000, requestCount: 320 },
        { date: "2024-01-05", totalCost: 11.2, tokenCount: 580000, requestCount: 350 },
        { date: "2024-01-06", totalCost: 6.3, tokenCount: 350000, requestCount: 210 },
        { date: "2024-01-07", totalCost: 4.9, tokenCount: 280000, requestCount: 180 },
      ]);
      setIsLoading(false);
      return;
    }
      ...
      {noOrg && (
        <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg">
          <p className="text-sm text-amber-600 dark:text-amber-400">
            <strong>Setup required:</strong> Complete your organization setup to view cost
            analytics.{" "}
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      ...
                      {summary.last30Days.requestCount > 0
                        ? (summary.last30Days.totalCost / summary.last30Days.requestCount).toFixed(
                            4,
                          )
                        : "0.0000"}
                    </div>
            ...
            <TabsContent value="pricing" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Current pricing per million tokens</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-amber-500/50">
                <CardHeader>
                  ...
                  <CardDescription>Set up alerts for cost thresholds</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Cost alerting is coming soon. You'll be able to set daily, weekly, and monthly
                    budget alerts.
                  </p>
                </CardContent>
              </Card>
