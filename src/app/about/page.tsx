        ...
        <section className="mb-12 sm:mb-16">
          <div className="rounded-lg border border-border bg-card p-6 sm:p-8">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-3 sm:mb-4">
              AI systems are fundamentally different from traditional software. They're
              probabilistic, context-dependent, and can fail in unexpected ways. Yet most teams are
              building AI products with the same testing tools designed for deterministic code.
            </p>
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
              We believe every AI product needs rigorous evaluation before reaching users. Our
              platform provides the tools to test, monitor, and continuously improve AI systems —
              from unit tests in development to A/B tests in production.
            </p>
          </div>
        </section>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    From unit tests in your IDE to production monitoring, we cover the entire AI
                    development lifecycle. No need to stitch together multiple tools.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-border bg-card p-5 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Combine the scale of LLM judges with the nuance of human review. Train judge
                    models on your specific quality criteria.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
            <div className="rounded-lg border border-border bg-card p-5 sm:p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Ship AI features faster with built-in quality assurance. Catch issues before users
                do and iterate with confidence.
              </p>
            </div>
            <div className="rounded-lg border border-border bg-card p-5 sm:p-6">
            ...
            <div className="rounded-lg border border-border bg-card p-5 sm:p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Focus on building, not infrastructure. We handle the complexity of evaluation at
                scale so you can focus on your models.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="rounded-lg border border-border bg-card p-6 sm:p-8">
            <div className="space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We learn from practitioners building in production. Your feedback shapes our
                  roadmap.
                </p>
              </div>
            </div>
