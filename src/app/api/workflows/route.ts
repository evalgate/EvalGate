...
import { internalError, quotaExceeded, validationError, zodValidationError } from '@/lib/api/errors';
...
export const POST = secureRoute(async (req: NextRequest, ctx: AuthContext) => {
  ...
  if (!orgLimitCheck.allowed) {
    return quotaExceeded("You've reached your workflow limit for this organization. Please upgrade your plan.");
  }
