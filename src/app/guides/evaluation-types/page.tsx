    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 flex-1">
        ...
        <div className="prose prose-sm sm:prose-base max-w-none">
          <p>
            The AI Evaluation Platform supports four distinct evaluation methodologies, each serving
            different purposes in your AI development lifecycle. Understanding when to use each type
            is key to building reliable AI systems.
          </p>

          <h2>1. Unit Tests</h2>
          <p>
            <strong>Best for:</strong> Regression testing, deterministic behavior, continuous
            integration
          </p>
          <div className="bg-card border border-border p-6 rounded-lg my-6">
            <h3 className="mt-0">How It Works</h3>
            <p>
              Unit tests define explicit input/output pairs and assertion rules. They pass or fail
              based on deterministic criteria like exact string matching, regex patterns, or
              programmatic checks.
            </p>
          </div>
          <p>
          ...
          <p>
            <strong>Limitations:</strong> Can be brittle for creative or open-ended tasks.
          </p>
          ...
          <div className="bg-card border border-border p-6 rounded-lg my-6">
            <h3 className="mt-0">How It Works</h3>
            <p>
              Human evaluators review AI outputs and provide ratings or feedback. The platform
              presents test cases to annotators, collects their judgments, and aggregates results
              into quality scores.
            </p>
          </div>
          <p>
          ...
          <p>
            <strong>Limitations:</strong> Slow, expensive, and doesn't scale to large test suites.
          </p>

          <h2>3. LLM Judge</h2>
          <p>
            <strong>Best for:</strong> Scalable quality assessment, complex reasoning tasks,
            mimicking human judgment
          </p>
          <div className="bg-card border border-border p-6 rounded-lg my-6">
            <h3 className="mt-0">How It Works</h3>
            <p>
              A separate LLM (the "judge") evaluates outputs from your target LLM based on custom
              rubrics. The judge scores outputs on dimensions like accuracy, relevance, helpfulness,
              or safety.
            </p>
          </div>
          <p>
          ...
          <p>
            <strong>Limitations:</strong> Judges can have biases and may not catch all edge cases.
          </p>

          <h2>4. A/B Testing</h2>
          <p>
            <strong>Best for:</strong> Production experimentation, comparing model versions,
            data-driven decisions
          </p>
          <div className="bg-card border border-border p-6 rounded-lg my-6">
            <h3 className="mt-0">How It Works</h3>
            <p>
              Traffic is split between two variants (e.g., old prompt vs. new prompt, GPT-3.5 vs.
              GPT-4). Statistical analysis determines which performs better based on real user
              interactions.
            </p>
          </div>
          <p>
          ...
          <p>
            <strong>Limitations:</strong> Requires significant traffic and time to reach statistical
            significance.
          </p>

          <h2>Combining Evaluation Types</h2>
          <p>The most robust evaluation strategies use multiple types together:</p>
          <div className="bg-muted p-6 rounded-lg my-6">
            ...
            <ol className="mb-0">
              ...
              <li>
                <strong>Pre-release:</strong> Use LLM judge on comprehensive test suite
              </li>
              <li>
                <strong>Validation:</strong> Human evaluation on sample of critical cases
              </li>
              <li>
                <strong>Production:</strong> A/B test with real users to confirm improvements
              </li>
            </ol>
          </div>
          ...
          <ul>
            <li>
              <Link href="/guides/quick-start" className="text-blue-500 hover:underline">
                Create your first unit test evaluation
              </Link>
            </li>
            <li>
              <Link href="/guides/llm-judge" className="text-blue-500 hover:underline">
                Learn to build custom LLM judge rubrics
              </Link>
            </li>
            <li>
              <Link href="/guides/ab-testing" className="text-blue-500 hover:underline">
