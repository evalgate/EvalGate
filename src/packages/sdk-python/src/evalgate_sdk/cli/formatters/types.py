...
FailureReasonCode = Literal[
    "PASS", "WARN_REGRESSION", "LOW_SAMPLE_SIZE", "BASELINE_MISSING",
    "SCORE_TOO_LOW", "DELTA_TOO_HIGH", "COST_BUDGET_EXCEEDED",
    "LATENCY_BUDGET_EXCEEDED", "POLICY_FAILED", "UNKNOWN",
    "LOW_SCORE", "LOW_PASS_RATE", "SAFETY_RISK", "LATENCY_RISK",
    "COST_RISK", "MAX_DROP_EXCEEDED", "INSUFFICIENT_EVIDENCE", "POLICY_VIOLATION",
]
