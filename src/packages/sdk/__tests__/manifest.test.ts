...
import { generateManifest, readLock, readManifest, writeManifest } from "../src/cli/manifest";
...
`;
  ...
  it("should generate manifest with correct schema", async () => {
    ...
    const manifest = await generateManifest(specs, testDir, "test-project", executionMode);
