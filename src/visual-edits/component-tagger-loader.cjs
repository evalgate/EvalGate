...
const findMapContext = (node, variables) => {
  ...
  while (current && depth < maxDepth) {
    if (
      ...
      if (
        arrayName &&
        (mapCallback === null || mapCallback === void 0 ? void 0 : mapCallback.type) ===
        ...
        if (
          (itemParam === null || itemParam === void 0 ? void 0 : itemParam.type) === "Identifier"
        ) {
          ...
          return {
            ...
            indexVarName:
              (indexParam === null || indexParam === void 0 ? void 0 : indexParam.type) ===
              "Identifier"
                ? indexParam.name
                : undefined,
          };
        ...
        (_a = node.attributes) === null || _a === void 0
          ...
          : _a.forEach((attr) => {
              ...
              if (
                ...
                ((_a = attr.value) === null || _a === void 0 ? void 0 : _a.type) ===
                  "JSXExpressionContainer" &&
                ((_b = attr.value.expression) === null || _b === void 0 ? void 0 : _b.type) ===
                  "Identifier"
              ) {
